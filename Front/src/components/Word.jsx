...
/* On relie l'API en methode POST*/
    const fetchWord = () => {
...
/* Création de la fonction qui vérifie si une lettre donnée par l'utilisateur fait partie du mot */
...
/* Permet de faire fonctionner le clavier  et verifie si la lettre est correcte*/
...
/* Verifie si la lettre est correcte ou non et met à jour l'état */
...
/* Si l'utilisateur veut Restart ca reinitialise le nombre d'essaie et recupere un nouveau mot */
